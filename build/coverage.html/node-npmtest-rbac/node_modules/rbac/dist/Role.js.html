...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-rbac/node_modules/rbac/dist/Role.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-rbac/node_modules/rbac/dist/Role.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-rbac/node_modules/rbac/dist/</a> &#187; Role.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Role(rbac, name, add, cb) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Role);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_Permission2.default.isValidName(name)) {</span>
<span class="cstat-no" title="statement not covered" >      var _ret;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _ret = cb(new Error('Role has no valid name')), _possibleConstructorReturn(_this, _ret);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Role.__proto__ || Object.getPrototypeOf(Role)).call(this, rbac, name, add, cb));</span>
  }
&nbsp;
  /**
...
&nbsp;
  _createClass(Role, [{
    key: 'grant',
    value: <span class="fstat-no" title="function not covered" >function grant(item, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.grant(this, item, cb);</span>
...
&nbsp;
    ...
    key: 'revoke',
    value: <span class="fstat-no" title="function not covered" >function revoke(item, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.revoke(this, item, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'can',
    value: <span class="fstat-no" title="function not covered" >function can(action, resource, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.can(this.name, action, resource, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'canAny',
    value: <span class="fstat-no" title="function not covered" >function canAny(permissions, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.canAny(this.name, permissions, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'canAll',
    value: <span class="fstat-no" title="function not covered" >function canAll(permissions, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.canAll(this.name, permissions, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'hasRole',
    value: <span class="fstat-no" title="function not covered" >function hasRole(roleChildName, cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.hasRole(this.name, roleChildName, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getScope',
    value: <span class="fstat-no" title="function not covered" >function getScope(cb) {</span>
<span class="cstat-no" title="statement not covered" >      this.rbac.getScope(this.name, cb);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
  }]);
&nbsp;
